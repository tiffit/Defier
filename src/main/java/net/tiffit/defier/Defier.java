...
@Mod(modid = Defier.MODID, version = Defier.VERSION, name = Defier.NAME, useMetadata = true, dependencies = "required-after:codechickenlib;required-after:redstoneflux;")
