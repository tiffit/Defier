...
public class ConfigData {
	...
	public static void load(Configuration config){
		...
		COMPRESSOR_BLACKLIST = config.getStringList("compressor.blacklist", "Balance", new String[0], "Item blacklist for the compressor. Example for cobblestone: \"minecraft:cobblestone\"");
